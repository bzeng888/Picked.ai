...
/** Scans real extracted text for sector + general keywords, target firm tiers, and light contact/education signals. */
function analyzeResumeText(rawText, sector, fileName) {
  ...
  const gpaMatch = text.match(/GPA[:\s]*([0-4]\.\d{1,2})/i) || text.match(/([0-4]\.\d{1,2})\s*\/\s*4\.0+/);
